...
registerDataModels()
{
  ...
  ret->registerModel<ImageShowModel>("Displays");
  ...
  ret->registerModel<MaxPoolingModel>("Operators");
...
main(int argc, char *argv[])
{
  ...
  mainWidget.setWindowTitle("Deep Learning Node Graph");
  mainWidget.resize(2560, 1440);
